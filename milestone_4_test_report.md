...
**Generated On**: 2026-08-13 15:31:26  
...
| **Average Response Time** | **22.9 ms** | &le; 2500 ms | **PASSED** |
...
| :- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :-: |
| 1 | Java Exceptions | `TC-01` | Critical | P1 | Payment | 51ms | Indexed New Knowledge (<=90%) | **PASS** |
| 2 | Python Errors | `TC-02` | Critical | P1 | Authentication | 19ms | Indexed New Knowledge (<=90%) | **PASS** |
| 3 | JavaScript Errors | `TC-03` | Medium | P3 | Dashboard | 17ms | Indexed New Knowledge (<=90%) | **PASS** |
| 4 | React Errors | `TC-04` | Medium | P3 | User Management | 19ms | Indexed New Knowledge (<=90%) | **PASS** |
| 5 | Node Errors | `TC-05` | High | P2 | Notifications | 18ms | Indexed New Knowledge (<=90%) | **PASS** |
| 6 | SQL Errors | `TC-06` | High | P1 | Database | 26ms | Indexed New Knowledge (<=90%) | **PASS** |
| 7 | Null Pointer | `TC-07` | Critical | P1 | API | 19ms | Indexed New Knowledge (<=90%) | **PASS** |
| 8 | Memory Leak | `TC-08` | Critical | P1 | Reports | 21ms | Indexed New Knowledge (<=90%) | **PASS** |
| 9 | API Failure | `TC-09` | High | P1 | API | 21ms | Indexed New Knowledge (<=90%) | **PASS** |
| 10 | Network Timeout | `TC-10` | High | P1 | Search | 17ms | Indexed New Knowledge (<=90%) | **PASS** |
| 11 | Authentication Failure | `TC-11` | High | P1 | Security | 18ms | Indexed New Knowledge (<=90%) | **PASS** |
| 12 | Validation Errors | `TC-12` | Low | P4 | Payment | 29ms | Indexed New Knowledge (<=90%) | **PASS** |
